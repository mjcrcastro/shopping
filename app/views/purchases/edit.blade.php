    ...
    function addToProducts(productArray) {
        ...
        for (var i = 0; i < productArray.length; i++) {
            ...
            $('<div class="container container-fluid">' +
                    ...
                    '<div class="col-xs-3"> <input class="form-control input-sm" name="amount[]" type="number" "step"=>"any" value="' + productArray[i].amount + '"> </div> ' +
                    '<div class="col-xs-3"> <input class="form-control input-sm" name="total[]" type="number" "step"=>"any" value="' + productArray[i].total + '"> </div> ' +
